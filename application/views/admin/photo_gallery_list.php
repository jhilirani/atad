...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr id="PageHeading">
    <td class="PageHeading" >Phot gallery Manager</td>
  </tr>
  ...
  <tr>
    <td style="padding-left:10px;"><input type="button" name="AddBtn" id="AddBtn" value="Add Photo gallery" onclick="ShowAddAdminBox();" class="common_button"/></td>
  </tr>
...
function ShowAddAdminBox(){
 ...
 function ShowEditBox(id){
    ...
    $('#PhotoGalleryID').val(DataArr[id]['PhotoGalleryID']);
...
function AskDelete(id)
{
	...
	{
		location.href='<?php echo base_url()?>admin/photo_gallery/delete/'+id;
	}
	return false;
}
 </script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable" height="20px;">
	...
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="ShowEditBox('<?php echo $InerArr->PhotoGalleryID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>edit.png" width="15" height="15" title="Edit"/></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="AskDelete('<?php echo $InerArr->PhotoGalleryID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>delete.png" width="15" height="15" title="Delete"/></a>
	</td> 
  </tr>
  <script language="javascript">
  DataArr[<?php echo $InerArr->PhotoGalleryID?>]=new Array();
  DataArr[<?php echo $InerArr->PhotoGalleryID?>]['PhotoGalleryID']='<?php echo $InerArr->PhotoGalleryID?>';
  DataArr[<?php echo $InerArr->PhotoGalleryID?>]['Image']='<?php echo $InerArr->Image?>';
  DataArr[<?php echo $InerArr->PhotoGalleryID?>]['CategoryID']='<?php echo $InerArr->CategoryID?>';
  DataArr[<?php echo $InerArr->PhotoGalleryID?>]['Status']='<?php echo $InerArr->Status?>';
  </script>
  <?php $val++;}
  }else{?>
  ...
  <tr>
    <td><form name="AdminEdit" id="AdminEdit" method="post" action="<?=base_url()?>admin/photo_gallery/edit/" enctype="multipart/form-data">
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="EditBox" style="display:none;">
  <tr>
    <th colspan="4"><span class="PageHeading">Photo gallery Edit Form</span></th>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top" class="ListHeadingLable"> Photo gallery Image </td>
...
<input name="EditStatus" type="radio" value="0"  class="required"/></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><input type="submit" name="Submit3" value="Submit" class="common_button"/>&nbsp;&nbsp;&nbsp;
	  ...
	  <input  type="hidden" name="PhotoGalleryID"  id="PhotoGalleryID" value=""/>
  ...
  <tr>
    <td><form name="AdminAdd" id="AdminAdd" method="post" action="<?=base_url()?>admin/photo_gallery/add"  enctype="multipart/form-data">
