...
<div id="header">
    <div class="logo"> <h1 align="center" style="color:#fff; font-size:20px; line-height:70px;"><img src="<?=$SiteImagesURL?>admin/logo.png" height="100" width="100" alt="" style="padding-top:30px;" />.COM Administrator Panel</h1></div>
</div>
<div class="clear"></div>

<form name="logFrm" action="<?php echo base_url().'admin/index/check_login/'?>" method="post">
