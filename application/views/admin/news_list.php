...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr id="PageHeading">
    <td class="PageHeading" >News Manager</td>
  </tr>
  ...
  <tr>
    <td style="padding-left:10px;"><input type="button" name="AddBtn" id="AddBtn" value="Add News" onclick="ShowAddAdminBox();" class="common_button"/></td>
  </tr>
...
function AskDelete(id)
{
	...
	{
		location.href='<?php echo base_url()?>admin/news/delete/'+id;
	}
	return false;
}
 </script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable" height="20px;">
    ...
    <td><?php echo $InerArr->News;?></td>
    <td><?php echo date('d-m-Y',strtotime($InerArr->PostedDate));?></td>
    <td>
	<a href="javascript:void(0);" onclick="ShowEditBox('<?php echo $InerArr->NewsID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>edit.png" width="15" height="15" title="Edit"/></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="AskDelete('<?php echo $InerArr->NewsID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>delete.png" width="15" height="15" title="Delete"/></a>
	</td> 
  </tr>
  <script language="javascript">
  DataArr[<?php echo $InerArr->NewsID?>]=new Array();
  DataArr[<?php echo $InerArr->NewsID?>]['NewsID']='<?php echo $InerArr->NewsID?>';
  DataArr[<?php echo $InerArr->NewsID?>]['News']='<?php echo $InerArr->News?>';
  DataArr[<?php echo $InerArr->NewsID?>]['Status']='<?php echo $InerArr->Status?>';
  </script>
  <?php $val++;}
  }else{?>
  ...
  <tr>
    <td><form name="AdminEdit" id="AdminEdit" method="post" action="<?=base_url()?>admin/news/edit/">
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="EditBox" style="display:none;">
  <tr>
    <th colspan="4"><span class="PageHeading">News Edit Form</span></th>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top" class="ListHeadingLable"> News </td>
    <td align="left" valign="top"><label><strong>:</strong></label></td>
    <td align="left" valign="top"><textarea name="EditNews" id="EditNews" class="required"></textarea></td>
  </tr>
  <tr>
    <td align="left" valign="top" height="40px;">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
...
<input name="EditStatus" type="radio" value="0"  class="required"/></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><input type="submit" name="Submit3" value="Submit" class="common_button"/>&nbsp;&nbsp;&nbsp;
	  ...
	  <input  type="hidden" name="NewsID"  id="NewsID" value=""/></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td><form name="AdminAdd" id="AdminAdd" method="post" action="<?=base_url()?>admin/news/add" >
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="AddBox" style="display:none;">
  <tr>
    ...
    <th width="66%" align="left" valign="top" scope="col"><span class="PageHeading">News Add Form</span></th>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="ListHeadingLable"> News </td>
    <td align="left" valign="top"><label><strong>:</strong></label></td>
    <td align="left" valign="top"><textarea name="News" id="News" class="required"></textarea></td>
  </tr>
  <tr>
    <td align="left" valign="top" height="40px;">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
